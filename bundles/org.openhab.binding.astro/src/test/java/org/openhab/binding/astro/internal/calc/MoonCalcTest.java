...
public class MoonCalcTest {
    ...
    public void testGetMoonInfoForApogeeAccuracy() {
        ...
        assertEquals(406391, moon.getApogee().getDistanceAsDouble(), ACCURACY_IN_KILOMETRES);
    ...
    public void testGetMoonInfoForPerigeeAccuracy() {
        ...
        assertEquals(359377, moon.getPerigee().getDistanceAsDouble(), ACCURACY_IN_KILOMETRES);
    ...
    public void testGetMoonInfoForMoonDistanceAccuracy() {
        ...
        assertEquals(392612, moon.getDistance().getDistanceAsDouble(), ACCURACY_IN_KILOMETRES);
    }
